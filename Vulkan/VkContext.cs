        ...
        void* pUserData)
    {
        ...
        var colors =
            new Dictionary<DebugUtilsMessageSeverityFlagsEXT,
                ConsoleColor>();
        colors[DebugUtilsMessageSeverityFlagsEXT.WarningBitExt] =
            ConsoleColor.Yellow;
        colors[DebugUtilsMessageSeverityFlagsEXT.ErrorBitExt] =
            ConsoleColor.Red;
        colors[DebugUtilsMessageSeverityFlagsEXT.InfoBitExt] =
            ConsoleColor.Blue;
